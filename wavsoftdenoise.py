import matplotlib.pyplot# -*- coding: utf-8 -*-
"""
...
#
def wavthreshold(dirwav, filename, outdir, dp, dl, thrwx, thrwy):
    nj=4
    h = bfilter(4)
    ...
    inDWT(dirwav, filename, outdir, filename,  nj, dp, dl, 1, 1)
